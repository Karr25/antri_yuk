...
<div class="col-lg-6 col-12">
	...
	<table>
		<tr>
		<td width="40%" class="px-4"><img class="mb-2 img img-thumbnail" style="width: 250px;" src="http://localhost/antriyuk/node_module/assets/foto_profil/<?= $_SESSION['user']['file_foto_profil']; ?>">
		<img class="mb-2 img img-thumbnail" style="width: 250px;" src="http://localhost/antriyuk/node_module/assets/barcode_admin/default.gif">
		</td>
...
<div class="col-lg-6 col-12">
	...
	<form action="proses_ganti_foto_profil.php" method="post" enctype="multipart/form-data">
		...
		<br>
		<b>
		<input style="color: white;" type="submit" value="Ganti"  class="btn btn-success" />
		<hr>
		</b>
	</form>
	<br>
	...
	<form action="proses_ganti_informasi.php" method="post">
		...
		<input type="submit" style="color: white;" value="Edit" class="btn btn-success mb-3" />
		<hr>
